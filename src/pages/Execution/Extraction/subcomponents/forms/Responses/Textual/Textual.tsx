...
export default function TextualResponse({question}: TextualResponseProps){
    ...
    return (
        <FormControl sx={container}>
            ...
            <Textarea value={response} onChange={(e) => setResponse(e.target.value)} sx={responseArea} _placeholder={{opacity: 1, color: "gray.500"}} placeholder="Your response" focusBorderColor="#2E4B6C"/>
        </FormControl>
    )
}