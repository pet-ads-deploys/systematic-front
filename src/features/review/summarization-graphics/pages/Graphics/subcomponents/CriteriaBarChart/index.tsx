...
export default function CriteriaBarChart({ criteria, stage ,filteredStudies}: Props) {
...
const filteredStudiesIds = filteredStudies
  ...
  .filter((id): id is number => id !== null);
    ...
    const filteredStageIds = stageStudyIds.filter(
    (id) => filteredStudiesIds.includes(id)
